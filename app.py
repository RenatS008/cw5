...
from locales.base import Arena
from locales.equipment import Equipment
from locales.classes import unit_classes
from locales.unit import BaseUnit, PlayerUnit, EnemyUnit
...
def use_skill():
    ...
    if arena.game_is_running and arena.player_use_skill():
